...
Said dates are computed in the first part of the InterplanetaryMission_group_33 script and they are:
...
The final transfer strategy is composed of two arcs, which connect inside Venus's SOI.
The transfer strategy is completed between the times 00:00:25 on February 1st 2031 and 02:47:46 on February 7th 2055. The powered flyby is performed at 13:23:59 on July 4th 2047.\\
...
The initial position is characterized by a true anomaly (f) of 188.49°. In Cartesian coordinates the initial point is identified by the following data:
...
The initial position’s distance from the Sun is 29.8908AU and the velocity at the initial point is 4.721 km/s.
The final position is characterized by a true anomaly (f) of 78.33°. In Cartesian coordinates the initial point is identified by the following data:
