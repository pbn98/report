...
\begin{figure}[H]
\centering
\includegraphics[width =\textwidth]{/Interplanetary/complete_strategy.png}
...
\centering
\begin{tabular}{ccc}
\subfloat{\includegraphics[width =0.9\textwidth]{/Interplanetary/complete_strategy_b.png}} \\
\end{tabular}
...
\begin{figure}[H]
\centering
\epsfig{file=orbitrepresentation1.eps, width=1\textwidth}
\caption{Orbit representation}
\end{figure}

\begin{figure}[H]
\centering
\epsfig{file=orbitevolution1.eps, width=1\textwidth}
...
\centering
\begin{tabular}{ccc}
\subfloat[semi-major axis]{\includegraphics[width = 3in]{Perturbations/Evolution/a.png}} &
\subfloat[eccentricity]{\includegraphics[width = 3in]{Perturbations/Evolution/e.png}} \\
\subfloat[inclination]{\includegraphics[width = 3in]{Perturbations/Evolution/i.png}} &
\subfloat[right ascension of ascending node]{\includegraphics[width = 3in]{Perturbations/Evolution/RAAN.png}}\\
\subfloat[perigee anomaly]{\includegraphics[width = 3in]{Perturbations/Evolution/omega.png}} &
\subfloat[true anomaly]{\includegraphics[width = 3in]{Perturbations/Evolution/f.png}} 
\end{tabular}
...
\epsfig{file=realsat.eps , width=\textwidth}
