...
\begin{figure}[H]
\centering
\epsfig{file= First_arc.eps, width=0.7\textwidth}
    \caption{First arc}
\end{figure}
...
\begin{figure}[H]
\centering
\epsfig{file= Second_arc.eps, width=0.7\textwidth}
    \caption{Second arc}
\end{figure}
...
-375.956 & 17.9234 & 6.3967                & 6728                   & 31.08                & 93.20                        & 86.80 \\ \hline
\end{tabular}%
}
\end{table}
...
\begin{figure}[H]
\centering
\epsfig{file= Flyby.eps, width=0.7\textwidth}
    \caption{Venus Flyby}
\end{figure}
