...
Master of Science in\\ Space Engineering \\
	...
	{\huge Group 33\\}
	\vspace{0.4cm}
	{\LARGE Marwan Alkady 967709 - 10761737\\ Pedro Bossi N\'{u}\~{n}ez 887651 - 10561223\\ Davide Demartini 888657 - 10574461\\ Davide Iafrate 967709 - 10800009\\ \par}
...
\begin{figure}[H]
\begin{tabular}{ccc}
\subfloat{\includegraphics[width = 2.4in]{Given_orbits_a.eps}} &
\subfloat{\includegraphics[width = 2.4in]{Given_orbits_b.eps}} \\
\end{tabular}
...
\begin{figure}[H]
\begin{tabular}{ccc}
\subfloat{\includegraphics[width = 2.4in]{Complete_strategy_a.eps}} &
\subfloat{\includegraphics[width = 2.4in]{Complete_strategy_b.eps}} \\
\end{tabular}
...
\begin{figure}[H]
\centering
\epsfig{file= First_arc.eps, width=\textwidth}
    \caption{First arc}
\end{figure}
...
\hline
\textbf{a [AU]} & \textbf{e [-]} & \textbf{i [°]} & \textbf{RAAN [°]} & \textbf{$\omega$  [°]} \\ \hline
3.8840         & 0.8981         & 0.0751         & 78.1190         & 95.9519                \\ \hline
\end{tabular}%
}
\end{table}
...
\hline
\textbf{R$_x$ [AU]}   & \textbf{R$_y$ [AU]}   & \textbf{R$_z$ [AU]}   \\ \hline
-0.1025   & - 0.7192   & -0.0036  \\ \hline
\textbf{v$_x$ [km/s]} & \textbf{v$_y$ [km/s]} & \textbf{v$_z$ [km/s]} \\ \hline
30.733              & -35.520              & -2.811              \\ \hline
\end{tabular}%
}
\end{table}
...
\hline
\textbf{R$_x$ [AU]}   & \textbf{R$_y$ [AU]}   & \textbf{R$_z$ [AU]}   \\ \hline
-0.3927   & -0.1153   & 0.0271  \\ \hline
\textbf{v$_x$ [km/s]} & \textbf{v$_y$ [km/s]} & \textbf{v$_z$ [km/s]} \\ \hline
6.404              & -63.674              & -1.457              \\ \hline
\end{tabular}%
}
\end{table}
...
\begin{figure}[H]
\centering
\epsfig{file= Second_arc.eps, width=\textwidth}
    \caption{Second arc}
\end{figure}
...
\hline
                             & \textbf{v$_x$ [km/s]} & \textbf{v$_y$ [km/s]} & \textbf{v$_z$ [km/s]} \\ \hline
\textbf{$V_{\infty}^{^{-}}$} & -0.906                & -30.687               & 0.749                 \\ \hline
\textbf{$V_{\infty}^{^{+}}$} & -3.705                & -30.439               & -0.752                \\ \hline
\end{tabular}%
}
\end{table}
...
-344.4569 & 19.2897 & 0.1038 & 6628 & 32.345 & 92.9716 & 87.0284 \\ \hline
\end{tabular}%
}
\end{table}
...
\hline
\textbf{a [km]} & \textbf{e [-]} & \textbf{$\delta$ [°]} & \textbf{$\Delta$ [km]} & \textbf{v$_p$ [km/s]} & \textbf{$\theta_{\infty}$ [°]} & \textbf{$\beta$ [°]} \\ \hline
-345.2779       & 19.2462        & 0.1038                & 6628                   & 32.311                & 92.9783                        & 87.0217              \\ \hline
\end{tabular}%
}
\end{table}
...
\begin{figure}[H]
\centering
\epsfig{file= Flyby.eps, width=\textwidth}
    \caption{Venus Flyby}
\end{figure}
...
\begin{figure}[H]
\begin{tabular}{ccc}
\subfloat[semi-major axis]{\includegraphics[width = 2.4in]{Perturbations/Evolution/a.png}} &
\subfloat[eccentricity]{\includegraphics[width = 2.4in]{Perturbations/Evolution/e.png}} \\
\subfloat[inclination]{\includegraphics[width = 2.4in]{Perturbations/Evolution/i.png}} &
\subfloat[right ascension of ascending node]{\includegraphics[width = 2.4in]{Perturbations/Evolution/RAAN.png}}\\
\subfloat[perigee anomaly]{\includegraphics[width = 2.4in]{Perturbations/Evolution/omega.png}} &
\subfloat[true anomaly]{\includegraphics[width = 2.4in]{Perturbations/Evolution/f.png}} 
\end{tabular}
...
\begin{tabular}{|c|c|c|c|c|}
\hline
\textbf{a [km]} & \textbf{e [-]} & \textbf{i [deg]} & \textbf{RAAN [deg]} & \textbf{$\omega$ [deg]} \\ \hline
35490.94        & 0.701992       & 78.63            & 260.60              & 306.12                \\ \hline
\end{tabular}%
}
\end{table}
...
%\epsfig{file=comparisonwithtles.eps , width=1\textwidth}
