...
\begin{itemize}
    ...
    \par \includegraphics[h,width=10cm]{RSW_Gauss_eqs.png}
    \par
    The reference frame for this equations is the RSW frame so $a_r, a_s, a_w$ are respectively the components radial, transversal and out-of-plane. \cite{RSW_Curtis} \cite{RSW_Vallado} \cite{RSW_Battin}
